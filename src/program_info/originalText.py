...
async def simple_fetch_with_playwright(url):
    async with async_playwright() as p:
        ...
        try:
            ...
            #await page.click('#program-requirements')
            #tabs > ul > li:nth-child(4)
            #ui-id-2 > div
            #ui-id-1 > div
            #await page.wait_for_selector('#ui-id-2 > div')
        except:
...
#print(asyncio.run(simple_fetch_with_playwright("https://grad.ucla.edu/programs/life-sciences/bioinformatics/")))