...
async def main(url_file,results_path,i,batch_size = 3):
    a = {}
    ...
    while i+batch_size<=len(graduate_urls):
        ...
        program_branches = await get_program_branches("../knowledge_files/grad_school_programs_url.json",i,batch_size)
...
asyncio.run(main(url_file,output_path,17,batch_size=2))
